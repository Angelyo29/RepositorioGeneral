...
public class Eslabon2 : MonoBehaviour
{
    ...
    void Update()
    {
        Vector3 displa = TransformSlave.localRotation.eulerAngles;
    ...
    void PrintAngleData(int angle)
    {
        ...
        {   
            ...
            //float correspondingTheta2 = theta2[index] - 130.146045077848f;
            float correspondingTheta3 = (theta3[index]- 17.7687185556759f)* coef;

            // Imprimir los valores
            //Debug.Log($"Para el ángulo {angle} en la posición {index}:");
            transform.localEulerAngles = new Vector3(-correspondingTheta3, 0, 0);

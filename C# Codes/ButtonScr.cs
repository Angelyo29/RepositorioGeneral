...
public class ButtonScr : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    void Start()
    {
        ...
        // Configurar detecci�n de presi�n continua
    ...
    // M�todo para restablecer rotaciones a valores iniciales
    ...
    private int rotationObj(int angleRotationLocal, int ObjValueLocal)
    {
        ...
        switch (ObjValueLocal)
        {
            ...
            default:
                Debug.LogWarning("Articulaci�n fuera de rango (1-6)");
                break;
        }
...
// Clase auxiliar para manejar cada bot�n
